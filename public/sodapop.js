...
const DataStore = {
    ...
    async init() {
        ...
        // 강원특별자치도 18개 시군
        this.generateSigungu('42', [
            '춘천시', '원주시', '강릉시', '동해시', '태백시', '속초시', '삼척시',
            '홍천군', '횡성군', '영월군', '평창군', '정선군', '철원군', '화천군', '양구군', '인제군', '고성군', '양양군'
        ]);
        // 충청북도 11개 시군
        this.generateSigungu('43', [
            '청주시', '충주시', '제천시', '보은군', '옥천군', '영동군', '증평군', '진천군', '괴산군', '음성군', '단양군'
        ]);
        // 충청남도 15개 시군
        this.generateSigungu('44', [
            '천안시', '공주시', '보령시', '아산시', '서산시', '논산시', '계룡시', '당진시',
            '금산군', '부여군', '서천군', '청양군', '홍성군', '예산군', '태안군'
        ]);
        // 전북특별자치도 14개 시군
        this.generateSigungu('45', [
            '전주시', '군산시', '익산시', '정읍시', '남원시', '김제시',
            '완주군', '진안군', '무주군', '장수군', '임실군', '순창군', '고창군', '부안군'
        ]);
        // 전라남도 22개 시군
        this.generateSigungu('46', [
            '목포시', '여수시', '순천시', '나주시', '광양시',
            '담양군', '곡성군', '구례군', '고흥군', '보성군', '화순군', '장흥군', '강진군',
            '해남군', '영암군', '무안군', '함평군', '영광군', '장성군', '완도군', '진도군', '신안군'
        ]);
        // 경상북도 23개 시군
        this.generateSigungu('47', [
            '포항시', '경주시', '김천시', '안동시', '구미시', '영주시', '영천시', '상주시', '문경시', '경산시',
            '군위군', '의성군', '청송군', '영양군', '영덕군', '청도군', '고령군', '성주군', '칠곡군', '예천군', '봉화군', '울진군', '울릉군'
        ]);
        // 경상남도 18개 시군
        this.generateSigungu('48', [
            '창원시', '진주시', '통영시', '사천시', '김해시', '밀양시', '거제시', '양산시',
            '의령군', '함안군', '창녕군', '고성군', '남해군', '하동군', '산청군', '함양군', '거창군', '합천군'
        ]);
        // 제주특별자치도 2개 시
        this.generateSigungu('50', ['제주시', '서귀포시']);

        // 서울 읍/면/동 데이터
        this.generateEmd('1111000000', ['청운효자동', '사직동', '삼청동', '부암동', '평창동', '무악동', '교남동', '가회동', '종로1234가동', '종로56가동', '이화동', '혜화동', '창신1동', '창신2동', '창신3동', '숭인1동', '숭인2동']); // 종로구
        this.generateEmd('1112000000', ['소공동', '회현동', '명동', '필동', '장충동', '광희동', '을지로동', '신당동', '다산동', '약수동', '청구동', '신당5동', '황학동', '중림동']); // 중구
        this.generateEmd('1113000000', ['후암동', '용산2가동', '남영동', '청파동', '원효로1동', '원효로2동', '효창동', '용문동', '한강로동', '이촌1동', '이촌2동', '이태원1동', '이태원2동', '한남동', '서빙고동', '보광동']); // 용산구
        this.generateEmd('1114000000', ['왕십리2동', '왕십리도선동', '마장동', '사근동', '행당1동', '행당2동', '응봉동', '금호1가동', '금호2.3가동', '금호4가동', '옥수동', '성수1가1동', '성수1가2동', '성수2가1동', '성수2가3동', '송정동', '용답동']); // 성동구
        this.generateEmd('1115000000', ['중곡1동', '중곡2동', '중곡3동', '중곡4동', '능동', '구의1동', '구의2동', '구의3동', '광장동', '자양1동', '자양2동', '자양3동', '자양4동', '화양동', '군자동']); // 광진구
        this.generateEmd('1116000000', ['용신동', '제기동', '전농1동', '전농2동', '답십리1동', '답십리2동', '장안1동', '장안2동', '청량리동', '회기동', '휘경1동', '휘경2동', '이문1동', '이문2동']); // 동대문구
        this.generateEmd('1117000000', ['중화1동', '중화2동', '묵1동', '묵2동', '망우본동', '망우3동', '상봉1동', '상봉2동', '면목본동', '면목2동', '면목3.8동', '면목4동', '면목5동', '면목7동', '신내1동', '신내2동']); // 중랑구
        this.generateEmd('1118000000', ['성북동', '삼선동', '동선동', '돈암1동', '돈암2동', '안암동', '보문동', '정릉1동', '정릉2동', '정릉3동', '정릉4동', '길음1동', '길음2동', '종암동', '월곡1동', '월곡2동', '장위1동', '장위2동', '장위3동', '석관동']); // 성북구
        this.generateEmd('1119000000', ['삼양동', '미아동', '송중동', '송천동', '삼각산동', '번1동', '번2동', '번3동', '수유1동', '수유2동', '수유3동', '우이동', '인수동']); // 강북구
        this.generateEmd('1120000000', ['쌍문1동', '쌍문2동', '쌍문3동', '쌍문4동', '방학1동', '방학2동', '방학3동', '창1동', '창2동', '창3동', '창4동', '창5동', '도봉1동', '도봉2동']); // 도봉구
        this.generateEmd('1121000000', ['월계1동', '월계2동', '월계3동', '광운동', '중계본동', '중계1동', '중계2.3동', '중계4동', '하계1동', '하계2동', '공릉1동', '공릉2동', '태릉1동', '태릉2동', '석계동', '상계1동', '상계2동', '상계3.4동', '상계5동', '상계6.7동', '상계8동', '상계9동', '상계10동']); // 노원구
        this.generateEmd('1122000000', ['녹번동', '불광1동', '불광2동', '갈현1동', '갈현2동', '구산동', '대조동', '응암1동', '응암2동', '응암3동', '역촌동', '신사1동', '신사2동', '증산동', '수색동', '진관동']); // 은평구
        this.generateEmd('1123000000', ['천연동', '북아현동', '홍제1동', '홍제2동', '홍제3동', '모래내시장동', '홍은1동', '홍은2동', '남가좌1동', '남가좌2동', '북가좌1동', '북가좌2동', '연희동', '신촌동', '창천동']); // 서대문구
        this.generateEmd('1124000000', ['아현동', '공덕동', '도화동', '용강동', '대흥동', '염리동', '신수동', '서강동', '서교동', '합정동', '망원1동', '망원2동', '연남동', '성산1동', '성산2동', '상암동']); // 마포구
        this.generateEmd('1125000000', ['목1동', '목2동', '목3동', '목4동', '목5동', '신정1동', '신정2동', '신정3동', '신정4동', '신정6동', '신정7동', '오목교동', '양천구청동']); // 양천구
        this.generateEmd('1126000000', ['염창동', '등촌1동', '등촌2동', '등촌3동', '화곡1동', '화곡2동', '화곡3동', '화곡4동', '화곡6동', '화곡8동', '우장산동', '발산1동', '공항동', '방화1동', '방화2동', '방화3동', '개화동', '마곡동', '가양1동', '가양2동', '가양3동']); // 강서구
        this.generateEmd('1127000000', ['고척1동', '고척2동', '개봉1동', '개봉2동', '개봉3동', '오류1동', '오류2동', '수궁동', '항동', '신도림동', '구로1동', '구로2동', '구로3동', '가리봉동', '구로5동']); // 구로구
        this.generateEmd('1128000000', ['독산1동', '독산2동', '독산3동', '독산4동', '시흥1동', '시흥2동', '시흥3동', '시흥4동', '시흥5동', '금천구청동']); // 금천구
        this.generateEmd('1129000000', ['영등포본동', '영등포동', '여의동', '당산1동', '당산2동', '도림동', '문래동', '양평1동', '양평2동', '신길1동', '신길3동', '신길4동', '신길5동', '신길6동', '신길7동', '대림1동', '대림2동', '대림3동']); // 영등포구
        this.generateEmd('1130000000', ['노량진1동', '노량진2동', '상도1동', '상도2동', '상도3동', '상도4동', '대방동', '신대방1동', '신대방2동', '흑석동', '동작동', '사당1동', '사당2동', '사당3동', '사당4동', '사당5동']); // 동작구
        this.generateEmd('1131000000', ['봉천동', '봉천1동', '봉천2동', '청림동', '행운동', '낙성대동', '청룡동', '은천동', '성현동', '관악동', '신림동', '신사동', '조원동', '중앙동', '서원동', '인헌동', '남현동', '서림동', '난향동', '난곡동', '미성동', '삼성동']); // 관악구
        this.generateEmd('1132000000', ['반포1동', '반포2동', '반포3동', '반포4동', '잠원동', '서초1동', '서초2동', '서초3동', '서초4동', '양재1동', '양재2동', '내곡동', '염곡동', '신원동', '방배1동', '방배2동', '방배3동', '방배본동']); // 서초구
        this.generateEmd('1133000000', ['신사동', '논현1동', '논현2동', '압구정동', '청담동', '삼성1동', '삼성2동', '대치1동', '대치2동', '대치4동', '개포1동', '개포2동', '개포4동', '일원본동', '일원1동', '일원2동', '수서동', '도곡1동', '도곡2동', '역삼1동', '역삼2동', '세곡동']); // 강남구
        this.generateEmd('1134000000', ['풍납1동', '풍납2동', '거여1동', '거여2동', '마천1동', '마천2동', '방이1동', '방이2동', '오금동', '개롱동', '송파1동', '송파2동', '석촌동', '삼전동', '가락1동', '가락2동', '문정1동', '문정2동', '장지동', '위례동', '잠실본동', '잠실2동', '잠실3동', '잠실4동', '잠실6동', '잠실7동']); // 송파구
        this.generateEmd('1135000000', ['강일동', '상일동', '고덕1동', '고덕2동', '암사1동', '암사2동', '암사3동', '천호1동', '천호2동', '천호3동', '성내1동', '성내2동', '성내3동', '길동', '둔촌1동', '둔촌2동', '명일1동', '명일2동']); // 강동구

        // 경기도 주요 시 실제 행정동 데이터
        this.generateEmd('4111000000', ['파장동', '율천동', '정자동', '조원동', '세류동', '권선동', '곡선동', '매탄동', '영통동', '망포동']); // 수원시
        this.generateEmd('4112000000', ['신흥동', '태평동', '상대원동', '분당동', '수내동', '정자동', '서현동', '이매동', '야탑동', '판교동']); // 성남시
        this.generateEmd('4113000000', ['의정부동', '호원동', '장암동', '신곡동', '송산동', '자금동', '가능동', '흥선동', '녹양동']); // 의정부시
        this.generateEmd('4114000000', ['안양동', '석수동', '박달동', '비산동', '부흥동', '달안동', '관양동', '부림동', '평촌동', '귀인동']); // 안양시
        this.generateEmd('4115000000', ['심곡동', '부천동', '중동', '상동', '신중동', '성곡동', '오정동']); // 부천시
        this.generateEmd('4119000000', ['일동', '이동', '사동', '본오동', '성포동', '와동', '원곡동', '초지동', '선부동', '대부동']); // 안산시
        this.generateEmd('4120000000', ['주교동', '원신동', '효자동', '흥도동', '식사동', '중산동', '정발산동', '마두동', '백석동', '탄현동']); // 고양시
        this.generateEmd('4123000000', ['다산동', '별내동', '양정동', '화도읍', '오남읍', '진접읍', '퇴계원읍', '와부읍', '조안면', '수동면']); // 남양주시
        this.generateEmd('4125000000', ['대야동', '신천동', '은행동', '매화동', '목감동', '군자동', '정왕동', '배곧동', '과림동', '연성동']); // 시흥시
        this.generateEmd('4129000000', ['신갈동', '구갈동', '상갈동', '기흥동', '서농동', '구성동', '마북동', '동백동', '보정동', '풍덕천동']); // 용인시
        this.generateEmd('4130000000', ['금촌동', '운정1동', '운정2동', '운정3동', '운정4동', '운정5동', '운정6동', '교하동', '문산읍', '법원읍']); // 파주시
    ...
    // 읍/면/동 데이터 생성 (시군구코드 앞 4자리 + 2자리 일련번호 + 0000)
    generateEmd(sigunguCode, names) {
        const prefix = sigunguCode.substring(0, 4);
        names.forEach((name, i) => {
            const code = `${prefix}${String(i + 11).padStart(2, '0')}0000`;
            const type = name.includes('면') || name.includes('리') ? 'rural' : 'urban';
            this.regions.set(code, this.generateRegionData(code, name, type));
        });
    },

    // 시군구에 속한 읍/면/동 목록 반환
    getEmdList(sigunguCode) {
        const prefix = sigunguCode.substring(0, 4);
        const list = [];
        this.regions.forEach((region, code) => {
            // 앞 4자리가 일치하고, 6자리 '000000'으로 끝나지 않는 것(읍면동 레벨)
            if (code.startsWith(prefix) && !code.endsWith('000000')) {
    ...
    getSigunguList(sidoCode) {
        ...
        this.regions.forEach((region, code) => {
            // 시군구: 앞 2자리가 시도코드와 일치하고, 뒤 6자리가 '000000'이지만 뒤 8자리는 '00000000'이 아닌 것
            if (code.startsWith(sidoPrefix) && code.endsWith('000000') && !code.endsWith('00000000')) {
                list.push({ code, name: region.name });
            }
        });
        return list;
...
const UI = {
    ...
    bindEvents() {
        ...
        if (dongSelect) {
            dongSelect.addEventListener('change', e => this.onDongChange(e.target.value));
        }
    ...
    onSigunguChange(code) {
        ...
        if (region) {
            ...
            // 읍/면/동 목록 채우기
            if (dongSelect) {
                const emdList = DataStore.getEmdList(code);
                if (emdList.length > 0) {
                    emdList.forEach(emd => {
                        const opt = document.createElement('option');
                        opt.value = emd.code;
                        opt.textContent = emd.name;
    ...
    onDongChange(code) {
        ...
        if (region) {
            ...
            const sidoInfo = DataStore.sidoCodes[code.substring(0, 2)];
            const sidoName = sidoInfo ? sidoInfo.name : '시/도';
            const sigunguName = sigunguSelect?.selectedOptions[0]?.text || '';
            this.updateBreadcrumb([sidoName, sigunguName, region.name]);
        }
    },
...
const WelfareSearch = {
    ...
    async search(query, page = 1) {
        ...
        try {
            ...
            console.error('WelfareSearch error:', error);
            resultsList.innerHTML = `<div class="welfare-error">검색 중 오류가 발생했습니다: ${error.message}</div>`;
        } finally {
    ...
    renderCard(item) {
        const ministryTag = item.ministry
            ? `<span class="welfare-meta-tag ministry">${item.ministry}</span>` : '';
        const lifeTag = item.life
        ...
        <div class="welfare-card">
            <div class="welfare-card-top">
                <span class="welfare-card-name">${item.name || '(제목 없음)'}</span>
    ...
    updatePager(totalCount, currentPage) {
        const pager    = document.getElementById('welfareResultsPager');
        const prevBtn  = document.getElementById('welfarePrevBtn');
        const nextBtn  = document.getElementById('welfareNextBtn');
        const pageInfo = document.getElementById('welfarePagerInfo');
