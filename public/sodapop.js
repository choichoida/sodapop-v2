...
const DataStore = {
    ...
    async init() {
        ...
        this.generateSigungu('11', ['강남구', '서초구', '송파구', '노원구', '마포구', '영등포구', '종로구', '중구']);
        this.generateSigungu('26', ['해운대구', '동래구', '부산진구', '사하구', '금정구', '북구']);
        this.generateSigungu('41', ['수원시', '성남시', '고양시', '용인시', '화성시', '안산시', '안양시', '부천시']);
        this.generateSigungu('27', ['수성구', '달서구', '북구', '동구', '중구']);
        this.generateSigungu('28', ['남동구', '부평구', '계양구', '서구', '연수구']);
